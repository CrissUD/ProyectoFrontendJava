...
public class LoginTemplate extends JFrame {
  ...
  private JLabel lFondo, lSvg1, lSvg2, lSvg3, lLogo, lUsuario, lClave, lFacebook, lTwitter, lYoutube;
  ...
  public JPanel getPSvg() { return this.pSvg; }
  ...
  public JButton getBOpcion(int boton) {
    if (boton == 1) return this.bOpcion1;
    if (boton == 2) return this.bOpcion2;
    if (boton == 3) return this.bOpcion3;
    return null;
  }
