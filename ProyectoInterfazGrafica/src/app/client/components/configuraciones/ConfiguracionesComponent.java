...
public class ConfiguracionesComponent implements MouseListener, MouseMotionListener, MouseWheelListener {
  ...
  public void mouseDragged(MouseEvent e) {
    this.configuracionesTemplate.getLLadoXValor()
      .setText(Math.abs((e.getX() - posicionInicialX)) + "");
    this.configuracionesTemplate.getLLadoYValor()
      .setText(Math.abs((e.getY() - posicionInicialY)) + "");
  }
  ...
  public void mouseWheelMoved(MouseWheelEvent e) {
    int valorZoomActual = Integer.parseInt(
